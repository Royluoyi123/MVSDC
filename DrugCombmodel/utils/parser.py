...
def parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="KGANSynergy/DrugCombDB", help="Choose a dataset:[Y08,luodatatset]")
    parser.add_argument(
        "--data_path", nargs="?", default="DrugCombmodel/data/", help="Input data path."
    )
