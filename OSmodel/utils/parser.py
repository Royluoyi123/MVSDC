...
def parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="KGANSynergy/OS", help="Choose a dataset:[Y08,luodatatset]")
    parser.add_argument(
        "--data_path", nargs="?", default="OSmodel/data/", help="Input data path."
    )
    ...
    parser.add_argument("--channel", type=int, default=256, help="hidden channels for model")
