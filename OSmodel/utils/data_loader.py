...
def trans_data(five_data):
    ...
    for drug_id_1,drug_id_2,cell_id,label,fold_num in five_data:
        if label == 1:
            posinter_mat.append([drug_id_1,cell_id-13043,drug_id_2])
            inter_mat.append([drug_id_1,cell_id-13043,drug_id_2,label])
        else:
            neginter_mat.append([drug_id_1,cell_id-13043,drug_id_2])
            inter_mat.append([drug_id_1,cell_id-13043,drug_id_2,label])
...
def get_kg(five_data):
    ...
    for drug_id_1,drug_id_2,cell_id,label,fold_num in five_data:
        if label ==1:
            kg_triplets.append([drug_id_1,cell_id-13043,drug_id_2])
    return kg_triplets
